...
def final_model(input_dim, filters, kernel_size, conv_stride,
    ...
    # Batch Normalization
    conv1_norm = BatchNormalization(name="conv1_norm")(conv_1d)
    
    # Bidirectionnal RNN
    bdir_rnn = Bidirectional(GRU(units, activation="relu",return_sequences=True, 
                 implementation=2, name="bdir_rnn"))(conv1_norm)
    
    # Batch Normalization
    bdir_rnn = BatchNormalization(name="bdir_rnn")(bdir_rnn)
    
    # Dropout
    dropout = Dropout(0.25) (bdir_rnn)
    
    # Time distributed
    time_dense1 = TimeDistributed(Dense(output_dim))(dropout)
